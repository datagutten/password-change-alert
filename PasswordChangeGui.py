...
class ChangePwdFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.TopAlertText.SetFont( wx.Font( 12, 70, 90, 92, False, wx.EmptyString ) )
		...
		self.PasswordRulesLink = wx.HyperlinkCtrl( self, wx.ID_ANY, _(u"Passordregler"), u"http://opplaring.as-admin.no/palogging/passordregler/", wx.DefaultPosition, wx.DefaultSize, wx.HL_DEFAULT_STYLE )
...
class SuccessDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.PasswordChangedText.SetFont( wx.Font( 14, 70, 90, 90, False, wx.EmptyString ) )
